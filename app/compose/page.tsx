...
export default function ComposePage() {
  ...
  return (
    <main className="space-y-4">
      <PageIntro title="Compose" description="Draft symbolic content, inspect structures, and flow into validate/export routes." cta="Tip: use Alt+key glyph shortcuts and ⌘/Ctrl+K for quick commands." />
